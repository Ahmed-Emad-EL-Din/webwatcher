...
files_to_ignore = ['package-lock.json', 'rename2.py', 'spider-logo.png', 'spider-bg-logo.png'] # Don't touch binary images
...
def replace_in_file(filepath):
    try:
        ...
        new_content = re.sub(r'\bWebspider\b', 'TheWebspider', content)
        new_content = re.sub(r'\bwebspider\b', 'thewebspider', new_content)
        new_content = re.sub(r'\bWEBSPIDER\b', 'THEWEBSPIDER', new_content)
        ...
        pass # Handle binary files or other errors gracefully
